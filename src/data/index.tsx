...
export const BentoItems = [
  {
    ...
    description:
      "Adaptive AI assesses the difficulty level of each generated question, ensuring a balanced and effective study experience.",
  ...
  },
  {
    ...
    description:
      "Users can save questions to a shared database, contributing to a communal study resource.",
  ...
  },
  {
    ...
    description:
      "See your study insights, track performance and study habits to learn more effectively and efficiently.",
  ...
  },
  {
    ...
    description:
      "Ensures the platform is accessible and fully functional on mobile devices.",
